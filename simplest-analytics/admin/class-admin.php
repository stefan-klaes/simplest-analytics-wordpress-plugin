...
class Simplest_Analytics_Admin
{
	...
	public function add_admin_menu()
	{
		...
		$access_webanalytics = isset($general_options["access_webanalytics"]) ? $general_options["access_webanalytics"] : array();
		$access_settings = isset($general_options["access_settings"]) ? $general_options["access_settings"] : array();

		$access_webanalytics[] = 'administrator';
		$access_settings[] = 'administrator';


		// Only add menu if the user has one of the allowed roles
		if (array_intersect($access_webanalytics, $user->roles)) {
		...
		if (array_intersect($access_settings, $user->roles)) {
